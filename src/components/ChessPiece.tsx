import { ChessPiece as ChessPieceType } from '../types/chess.ts';
  ...
  king: {
    white: (
      <svg viewBox="0 0 45 45" className="w-full h-full">
        <g fill="#ffffff" stroke="#000000" strokeWidth="1.5">
          ...
          <path d="M 11.5,37 C 17,40.5 27,40.5 32.5,37 L 32.5,30 C 32.5,30 41.5,25.5 38.5,19.5 C 34.5,13 25,16 22.5,23.5 L 22.5,27 L 22.5,23.5 C 20,16 10.5,13 6.5,19.5 C 3.5,25.5 12.5,30 12.5,30 L 11.5,37 z " fill="#ffffff" stroke="#000000"/>
    ...
    black: (
      <svg viewBox="0 0 45 45" className="w-full h-full">
        <g fill="#000000" stroke="#000000" strokeWidth="1.5">
          <path d="M 22.5,11.63 L 22.5,6" strokeLinejoin="miter"/>
          <path d="M 22.5,25 C 22.5,25 27,17.5 25.5,14.5 C 25.5,14.5 24.5,12 22.5,12 C 20.5,12 19.5,14.5 19.5,14.5 C 18,17.5 22.5,25 22.5,25" fill="#000000" stroke="#000000" strokeLinecap="butt" strokeLinejoin="miter"/>
          <path d="M 11.5,37 C 17,40.5 27,40.5 32.5,37 L 32.5,30 C 32.5,30 41.5,25.5 38.5,19.5 C 34.5,13 25,16 22.5,23.5 L 22.5,27 L 22.5,23.5 C 20,16 10.5,13 6.5,19.5 C 3.5,25.5 12.5,30 12.5,30 L 11.5,37 z " fill="#000000" stroke="#000000"/>
          <path d="M 20,8 L 25,8" strokeLinejoin="miter" stroke="#ffffff"/>
          <path d="M 32,29.5 C 32,29.5 40.5,25.5 38.03,19.85 C 34.15,14 25,18 22.5,24.5 L 22.51,26.6 L 22.5,24.5 C 20,18 10.85,14 6.97,19.85 C 4.5,25.5 13,29.5 13,29.5" fill="none" stroke="#ffffff"/>
          <path d="M 11.5,30 C 17,27 27,27 32.5,30 M 11.5,33.5 C 17,30.5 27,30.5 32.5,33.5 M 11.5,37 C 17,34 27,34 32.5,37" fill="none" stroke="#ffffff"/>
        </g>
      </svg>
    )
  },
    ...
    black: (
      <svg viewBox="0 0 45 45" className="w-full h-full">
        <g fill="#000000" stroke="#000000" strokeWidth="1.5">
          ...
          <path d="M 9,26 C 9,28 10.5,28 11.5,30 C 12.5,31.5 12.5,31 12,33.5 C 10.5,34.5 10.5,36 10.5,36 C 9,37.5 11,38.5 11,38.5 C 17.5,39.5 27.5,39.5 34,38.5 C 34,38.5 35.5,37.5 34,36 C 34,36 34.5,34.5 33,33.5 C 32.5,31 32.5,31.5 33.5,30 C 34.5,28 36,28 36,26 C 27.5,24.5 17.5,24.5 9,26 z"/>
          <path d="M 11.5,29.5 C 15.5,29.5 30.5,29.5 33.5,29.5" fill="none" stroke="#ffffff"/>
    ...
    black: (
      <svg viewBox="0 0 45 45" className="w-full h-full">
        <g fill="#000000" stroke="#000000" strokeWidth="1.5">
          ...
          <path d="M 11,14 L 34,14" fill="none" stroke="#ffffff" strokeLinejoin="miter"/>
        </g>
      </svg>
    )
  },
...
export const ChessPiece = ({ piece }: ChessPieceProps) => {
  const svg = pieceSVGs[piece.type][piece.color];
  
  return (
    <div className="w-12 h-12 select-none cursor-pointer transition-all duration-200 hover:scale-110 drop-shadow-lg">
      {svg}
    </div>
  );
};